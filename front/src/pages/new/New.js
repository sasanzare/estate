     ...
     <Container>
       <Row>
         ...
         <Form className="row pt-4" >
            ...
            name="city" 
            title="شهر"
             myClass="col-lg-5 col-md-6 col-sm-9 col-12 mx-auto text-dark"/>
            </Col>
            <Col sm={12}>
                <SingleSelect val={[
                    "معالی آباد",
                ...
                name="location" 
                title="محدوده"
                myClass="col-lg-5 col-md-6 col-sm-9 col-12 mx-auto"/>
             </Col>
             <Col sm={12}>
                <SingleSelect val={[
                    "فروش مسکونی",
            ...
            <Col sm={12}>
                <Form.Group className="col-lg-5 col-md-6 col-sm-9 col-12 mb-3 mx-auto" >
